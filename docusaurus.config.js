...
module.exports = {
  ...
  themeConfig: {
    announcementBar: {
      id: "support_us",
      content:
        'If you like <strong>CloudQuery</strong>, please  <a target="_blank" rel="noopener noreferrer" href="https://github.com/cloudquery/cloudquery/">star the project on GitHub</a>. Thanks for your support!',
      backgroundColor: "#0AD18E",
      textColor: "#171C24",
      isCloseable: true,
    },
    colorMode: {
    ...
    [
      "@docusaurus/preset-classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/cloudquery/docs/edit/main/",
        },
        // blog: {
