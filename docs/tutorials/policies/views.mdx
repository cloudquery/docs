...
You can read more about the log4j vulnerability and the `public_egress` policy in [this blog post](https://www.cloudquery.io/blog/aws-log4j-and-finding-unrestricted-outbound-access).
