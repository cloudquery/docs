...
Clone the [cloudquery/helm-charts](https://github.com/cloudquery/helm-charts) (all commands in this tutorial will assume
...
You can use the following terraform as is, fine-tune them and/or incorporate them into your existing 
...
* Add any additional environment variables under `envRenderSecret` needed for CloudQuery to authenticate with your cloud provider.
