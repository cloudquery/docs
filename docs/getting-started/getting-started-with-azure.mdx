...
<Tabs
  defaultValue="az_login"
  values={[
    {label: 'az login', value: 'az_login'},
    {label: 'Service Principal', value: 'service_principal'}
  ]}>

<TabItem value="az_login">
...
Once `config.yml` is generated and you are authenticated with Azure, run the following command to fetch the resources.
